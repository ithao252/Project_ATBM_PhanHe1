--HỆ THỐNG THÔNG TIN QUẢN LÝ S--

--to have the ability to CREATE USER
alter session set "_ORACLE_SCRIPT" = true;

--to CREATE USER manage tables
CREATE USER qlbv IDENTIFIED BY qlbvien;
GRANT ALL PRIVILEGES TO qlbv;
/*
DROP USER qlbv CASCADE;
*/

--to CREATE TABLE with the OWNER as USER
ALTER SESSION SET current_schema = QLBV;
