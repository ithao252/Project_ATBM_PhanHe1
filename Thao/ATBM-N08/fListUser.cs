...
namespace ATBM_N08
{
    public partial class fListUser : Form
    {
        ...
        {
            InitializeComponent();
            dtgv_User.CellClick += User_Delete_Click;  
        ...
        private void userPrivilege_btn_Click(object sender, EventArgs e)
        {
            CheckPrivilege c = new CheckPrivilege();
            c.Show();
        }

        private void button1_Click(object sender, EventArgs e)
        {
            CheckRole r = new CheckRole();
            r.Show();
        }
    }
}
